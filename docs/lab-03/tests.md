...
- [x] **Desktop (`>=992px`)**: All tables, multi-column forms, operational panels, and distinct notes sections render within 1200px centered layout.
- [x] **Tablet (`768px - 991px`)**: Queue toolbars wrap gracefully; forms scale without horizontal overflow.
- [x] **Mobile (`<768px`)**: Queue table converts into card items; login and change password fit screen; touch targets >= 44px; zero horizontal scrolling.
